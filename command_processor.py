...
class CommandProcessor:
    """Processes transcribed text to identify commands using OpenAI."""
    
    def __init__(self, command_registry: CommandRegistry):
        """
        Initialize a new CommandProcessor.
        
        Args:
            command_registry: The CommandRegistry containing available commands
        """
        self.command_registry = command_registry
        
    def interpret_command(self, transcription: str, api_key: str) -> Dict[str, Any]:
        """
        Use OpenAI to interpret which command the user wants to execute and extract parameters.
        ...
        Returns:
            dict: A dictionary with command name and parameters
        """
    ...
    def _create_system_prompt(self, command_schema: List[Dict[str, Any]], examples_formatted: str) -> str:
        ...
        return f"""You are a voice command interpreter that precisely identifies commands and extracts parameters from transcribed speech.
            
AVAILABLE COMMANDS:
{json.dumps(command_schema, indent=2)}
